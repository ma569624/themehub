...
const HeroSection = () => {
    return (
        <section className="position-relative d-flex align-items-center min-vh-100 py-5 bg-dark overflow-hidden">
            ...
            <div className="container position-relative mb-lg-5 mt-5 mb-md-4 mb-3 pt-3 pb-xl-3" data-bs-theme="dark">
                <div className="row gy-5">
                    <div className="col-xl-5 col-lg-6">
                        <div className="position-relative zindex-5 text-lg-start text-center">
                            {/* <h5 className="my-2">Welcome!</h5> */}
                            <h1 className="display-4 mb-4">Pick <span className="text-primary">Best Theme </span>  No Limits</h1>
                            <p className="fs-lg mb-5 text-white">Enjoy our great selection of IT courses. Choose from more than 25K online
                            ...
                            <div className="d-flex align-items-center mt-auto mb-3 mb-lg-0 pb-4 pb-lg-0 pb-xl-5">
                                ...
                                <span className="fs-sm text-white"><span className="text-primary fw-semibold ">10K+</span> Developer are already
                                    with us</span>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="position-relative ms-xl-0 ms-lg-4">
                            <div className="position-absolute top-50 start-50 translate-middle ratio ratio-1x1" style={{ width: '125%', maxWidth: '49.75rem' }}>
                                <div className="p-md-0 p-5">
                                    <img src="https://silicon.createx.studio/assets/img/landing/software-agency-3/hero-bg.png" alt="Shape" className="w-auto hero-animation-spin p-md-0 p-5" />
                                </div>
                            </div>
                            <div className="position-relative row row-cols-sm-2 row-cols-1 gx-xl-4 gx-lg-3 gx-md-4 gx-3">
                                <div className="col">
                                    <div className="d-sm-grid d-flex gap-xl-4 gap-lg-3 gap-md-4 gap-sm-3 gap-2">
                                        <div className="d-flex align-items-center justify-content-center bg-secondary rounded-3" style={{ overflow:'hidden', maxHeight: '246px', minHeight: '246px', backdropFilter: 'blur(6px)' }}>
                                            <div className="p-xl-4 p-sm-3 p-2 fs-xl fw-semibold text-center">
                                                <span className="hero-animation-fade text-white"><img src="https://silicon.createx.studio/assets/img/landing/intro/hero/screens01.png" alt="" /></span>
                                            </div>
                                        </div>
                                        <div className="d-flex align-items-center justify-content-center bg-secondary rounded-3" style={{ overflow:'hidden',maxHeight: '246px', minHeight: '246px', backdropFilter: 'blur(6px)' }}>
                                            <div className="p-xl-4 p-sm-3 p-2 fs-xl fw-semibold text-center">
                                                <span className="hero-animation-fade hero-animation-delay-2 text-white"><img src="https://silicon.createx.studio/assets/img/landing/intro/hero/screens01.png" alt="" /></span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div className="col mt-sm-1 mt-1 pt-sm-5">
                                    <div className="d-sm-grid d-flex gap-xl-4 gap-lg-3 gap-md-4 gap-sm-3 gap-2">
                                        <div className="d-flex align-items-center justify-content-center bg-secondary rounded-3" style={{ overflow:'hidden',maxHeight: '246px', minHeight: '246px', backdropFilter: 'blur(6px)' }}>
                                            <div className="p-xl-4 p-sm-3 p-2 fs-xl fw-semibold text-center">
                                                <span className="hero-animation-fade hero-animation-delay-1 text-white"><img src="https://silicon.createx.studio/assets/img/landing/intro/hero/screens01.png" alt="" /></span>
                                            </div>
                                        </div>
                                        <div className="d-flex align-items-center justify-content-center bg-secondary rounded-3" style={{ overflow:'hidden',maxHeight: '246px', minHeight: '246px', backdropFilter: 'blur(6px)' }}>
                                            <div className="p-xl-4 p-sm-3 p-2 fs-xl fw-semibold text-center">
                                                <span className="hero-animation-fade hero-animation-delay-3 text-white"><img src="https://silicon.createx.studio/assets/img/landing/intro/hero/screens01.png" alt="" /></span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
